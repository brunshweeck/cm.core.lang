...
namespace core
{
    namespace lang
    {
        ...
        public:
            ...
            /// Constructs a new throwable with the specified cause and a detail message of @c cause.toString() (which typically contains the class and detail message of @c cause).
            /// This constructor is useful for throwables that are little more than wrappers for other throwables.
            /// The @b fillInStackTrace() method is called to initialize the stack trace data in the newly created throwable.
            /// @param cause the cause (which is saved for later retrieval by the @b getCause() method).
            CORE_EXPLICIT Throwable(const Throwable& cause);
        ...
        private:
            ...
            ///     ...
            /// @endcode
            virtual void selfThrow() const = 0;
