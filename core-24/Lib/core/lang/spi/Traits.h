...
namespace core::lang::spi
{
    ...
    template<glong transform, glong ... otherTransforms>
    class __TypeChainedTransform<void, transform, otherTransforms...>
            : public __TypeChainedTransform<typename __TypeTransform<transform, void>::type, otherTransforms...>
    {
    };
...
#define __IS_RVALUE_TYPE  1LL << 0x35
    ...
    template<>
    class __TypeTransform<__REFERENCE_QUALIFIER, void> : public __AlwaysTrueType<void>
    {
    };

    template<>
    class __TypeTransform<__REFERENCE_QUALIFIER, const void> : public __AlwaysTrueType<const void>
    {
    };

    template<>
    class __TypeTransform<__REFERENCE_QUALIFIER, volatile void> : public __AlwaysTrueType<const void>
    {
    };

    template<>
    class __TypeTransform<__REFERENCE_QUALIFIER, const volatile void> : public __AlwaysTrueType<const volatile void>
    {
    };
    ...
    template<>
    class __TypeTransform<__REFERENCE_QUALIFIER | __LVALUE_QUALIFIER, void> : public __AlwaysTrueType<void>
    {
    };
    ...
    template<>
    class __TypeTransform<__REFERENCE_QUALIFIER | __RVALUE_QUALIFIER, void> : public __AlwaysTrueType<void>
    {
    };
    ...
    class __TypeTransform<
                __POINTER_QUALIFIER, T, -1,
                dimension> : public __TypeTransform<__POINTER_QUALIFIER, T *, -1, dimension - 1>
    {
    ...
    template<>
    class __TypeTransform<__ARRAY_QUALIFIER, void> : public __AlwaysTrueType<void>
    {
    };
    ...
    class __TypeTransform<__ARRAY_QUALIFIER, void, -1, dimension> : public __AlwaysTrueType<void>
    {
    };
    ...
    class __TypeTransform<__ARRAY_QUALIFIER, void, numberOfElements> : public __AlwaysTrueType<void>
    {
    };
    ...
    class __TypeTransform<__ARRAY_QUALIFIER, void, numberOfElements, dimension> : public __AlwaysTrueType<void>
    {
    };
    ...
    class __TypeTesting<__IS_INSTANCE_OF_TYPE, T, U> : public __AlwaysFalse
    {
        ...
        template<class __T, class __U, gboolean __W>
        class __TypeInstanceCheck<__T, __U, false, false, true, __W>
        {
        public:
        ...
        template<class __T, class __U, gboolean __W>
        class __TypeInstanceCheck<__T, __U, false, false, false, __W>
        {
        public:
            static CORE_FAST gboolean isInstanceOf(__U const &) { return false; }
        };
        ...
        template<class __T, class __U>
        class __TypeInstanceCheck<__T, __U, false, true, true, true>
        {
        public:
            static CORE_FAST gboolean isInstanceOf(__U const &) { return true; }
        };
        ...
        template<class __T, class __U>
        class __TypeInstanceCheck<__T, __U, false, true, true, false>
        {
        public:
