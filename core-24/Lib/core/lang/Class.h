...
namespace core
{
    ...
    public:
        ...
        /// Version of T without a @c const qualifier
        $alias(NoConstant,
        ...
        /// Version of T without a @c volatile qualifier
        $alias(NoVolatile,
       ...
       /// @tparam FallbackType The type returned if condition is @c false
        ...
        /// Return @c true if T is a pointer type
